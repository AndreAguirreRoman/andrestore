...
import { CreditCardInputLeft, CreditCardInputRight, CreditCardDate, CreditCardInputCV } from '../formFields';
        ...
        return (
            <form onSubmit={handleSubmit} className={`${className} cc-form`}>
                <div className='cc-form__fields'>
                    ...
                    <Field className='cc-form__bottom-exp' maxLength={2} title='Valid Thru' id={1} type='exp' placeholder="YY" name='exp' component={CreditCardDate} />
                ...
                <div className='cc-form__buttons'>
                    ...
                    <div className='cc-form__buttons__pay'>
                        <button onClick={() => console.log('pushing')} >Pay</button>
                    </div>
