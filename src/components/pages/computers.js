...
class Computers extends Component {
    ...
    render() {
        const computers = this.state.productItems.filter((productItem) => productItem.product_category_name.includes('Computer')).map(productItem => {
            return (
...
Computers = connect(null, actions)(Computers);
